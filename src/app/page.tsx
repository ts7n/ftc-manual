        ...
        <div id="navbar" className="bg-white p-4 grid grid-cols-3 border-b-2">
          ...
          <div className="flex justify-between">
            ...
            <a
              ...
              className="transition duration-200 flex gap-2 rounded-md bg-stone-100 px-3 py-2 text-sm font-semibold text-[#24292e] hover:bg-stone-200"
            >
              <svg className="w-5 h-5 my-auto fill-[#24292e]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
